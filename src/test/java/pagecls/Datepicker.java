...
public class Datepicker 
{
	...
	public void pickdate()
	{
		...
		WebElement going = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".eb46370fe1")));
		going.sendKeys("Cochin");
		WebElement checkin = driver.findElement(By.cssSelector(".a8887b152e"));
		checkin.click();
...
//		driver.findElement(By.xpath("//*[@id=\"indexsearch\"]/div[2]/div/div/form/div[1]/div[2]/div/div/button[1]")).click();
		...
		while(true)
		{
			...
			String monthtext=driver.findElement(By.xpath("button[data-testid=\"date-display-field-start\"]")).getText();
